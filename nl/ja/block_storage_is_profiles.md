...
# {{site.data.keyword.block_storage_is_short}} プロファイル
...
{: caption="表 1. IOPS ティア・プロファイルと各ティアのパフォーマンス・レベル" caption-side="top"}
...
{: caption="表 3. ブロック・ストレージ・プロファイルと仮想サーバー・プロファイルの関係" caption-side="top"}
